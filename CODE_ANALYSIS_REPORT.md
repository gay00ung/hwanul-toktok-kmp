...
> 이 문서는 과거 코드 스냅샷을 기준으로 작성되었습니다. 2026-08-18 긴급 안전 조치로
> Android/iOS의 광고 SDK, 광고 초기화, 배너 및 전면 광고 요청 경로를 모두 제거했으므로
> 아래의 AdMob 관련 평가는 현재 코드에 적용되지 않습니다.
...
| **알림** | ✅ 좋음 | 채널 관리 구현됨 |
| **AdMob 통합** | 제거됨 | 2026-08-18 광고 요청 경로 및 SDK 제거 |
